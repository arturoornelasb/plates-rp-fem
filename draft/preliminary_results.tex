...
\date{July 4, 2026 --- draft v0.4 (companion to the ``Why Rosenzweig--Porter?'' program)}
...
report an RP phase as an artifact. All experiments, gates, and raw data are
...
control law (E6). And the campaign's sharpest methodological product (E14)
...
Coriolis rotor (P6, GOE$\to$GUE); and comparison against the measured
aluminum-plate spectra of Ref.~\cite{lopez2021}.
