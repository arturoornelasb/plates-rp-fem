...
from e19_common import (A_AX, B_AX, KFEM, LADDER, MESH_PROD, NU,
                        superellipse_polar_mesh)
...
def main():
    ...
    mesh = superellipse_polar_mesh(*MESH_PROD)
    ...
    md = ["# E19 -- superellipse p = 10 true-operator windows (RESULTS)\n",
          f"Gates: {gates}\n",
          "| sector | N | true IPR |", "|---|---|---|"]
